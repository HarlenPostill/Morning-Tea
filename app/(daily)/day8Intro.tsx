...
export default function Day8Intro() {
  const now = new Date();
    ...
    <SafeAreaView>
      <View
        ...
        <View
          ...
          <MiffyText isItalic color={Colors.miffySeconday} text={`Good ${timeOfDay} Honey Bun`} />
          <Animated.Image
            style={[
            ...
            source={require('@assets/flowers/buttercup.png')}
          />
