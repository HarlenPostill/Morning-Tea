...
export default function Day15Intro() {
  const now = new Date();
    ...
    <SafeAreaView>
      <View
        ...
        <View
          ...
          <MiffyText isItalic color={Colors.miffySeconday} text={`Good ${timeOfDay} Honey Bunny`} />
          <Animated.Image
            style={[
            ...
            source={require('@assets/flowers/pansies.png')}
          />
