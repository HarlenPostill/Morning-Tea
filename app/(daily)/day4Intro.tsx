...
export default function Day4Intro() {
  const now = new Date();
    ...
    <SafeAreaView>
      <View
        ...
        <View
          ...
          <MiffyText isItalic color={Colors.miffySeconday} text={`Good ${timeOfDay} Snuggle Bug`} />
          <Animated.Image
            style={[
            ...
            source={require('@assets/flowers/daffodil.png')}
          />
