...
export default function Day18Intro() {
  const now = new Date();
    ...
    <SafeAreaView>
      <View
        ...
        <View
          ...
          <MiffyText isItalic color={Colors.miffySeconday} text={`Good ${timeOfDay} Love Bug`} />
          <Animated.Image
            style={[
            ...
            source={require('@assets/flowers/hydrangea.png')}
          />
