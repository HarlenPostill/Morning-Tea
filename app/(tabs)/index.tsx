...
const TIKTOK_URL = 'https://www.tiktok.com/@alecjimenez31/video/7250885316276669742?lang=en';
const SPOTIFY_URL = 'https://open.spotify.com/track/4zXuYQNDmw3dlauyc8q3Kd?si=2d720fe4a38a4b30';
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={[styles.dayContainer, { backgroundColor: Colors.miffyPrimary }]}>
          ...
          <MiffyText text="Day 12" size={36} isItalic color={Colors.miffySeconday} />
        </View>
        ...
        <View style={[styles.dayContainer, { backgroundColor: '#FCE0E5' }]}>
          ...
          <Text style={styles.flowerFactText}>
            Tulips were so valuable in 17th century Netherlands that they caused 'Tulip Mania', a
            speculative bubble where bulbs traded for prices higher than houses!
          </Text>
        </View>
        ...
        <View style={[styles.dayContainer, styles.mediaSectionContainer]}>
          ...
          <TouchableOpacity style={styles.mediaButton} onPress={() => openLink(YOUTUBE_URL)}>
            <MiffyText text="Daily Reel" size={30} color="#fff" />
          </TouchableOpacity>

          <TouchableOpacity style={styles.mediaButton} onPress={() => openLink(TIKTOK_URL)}>
        ...
        <View style={[styles.dayContainer, styles.songContainer]}>
          ...
          <View style={styles.songDetailsContainer}>
            <Text style={styles.songTitle}>Flightless bird, American Mouth</Text>
            <Image style={styles.songArtwork} source={require('@assets/songArt/1.jpg')} />
          </View>
          <TouchableOpacity style={styles.mediaButton} onPress={() => openLink(SPOTIFY_URL)}>
