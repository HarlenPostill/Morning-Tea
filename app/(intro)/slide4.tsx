        ...
        <View style={{ gap: 30, flex: 1 }}>
          ...
          >
            ...
            <MiffyText
              ...
              color={"#000"}
              text={
                "Hey Harlen, sorry for late reply. Yes I`m so in, making some up now!"
              }
            />
          </View>
          <View
          ...
          >
            ...
            <MiffyText
              size={22}
              color={"#000"}
              text={"That`s such a good idea awwwwwwww"}
            />
          </View>
          <View
            style={{
          ...
          >
            ...
            <MiffyText
              ...
              color={"#000"}
              text={
                "awww yes ofc! 🥹🥰 would love to do this! I`ll def check it out :)"
              }
            />
          </View>
          <View
          ...
          >
            ...
            <MiffyText
              size={22}
              color={"#000"}
              text={"oh my goodness this is so sweet 🥹"}
            />
          </View>
          <View
            style={{
          ...
          >
            ...
            <MiffyText
              size={22}
              color={"#000"}
              text={"Yeah awesome, i`d love to help out man"}
            />
          </View>
          <View
            style={{
          ...
          >
            ...
            <MiffyText
              size={22}
              color={"#000"}
              text={"Thats so cute! I`ll make one quick!"}
            />
          </View>
          <View
            style={{
          ...
          >
            ...
            <MiffyText
              ...
              color={"#000"}
              text={
                "ofc man I`ll smash one out for big A. Thats such a cool idea"
              }
            />
          </View>
          <View
          ...
          >
            <MiffyText
              size={22}
              color={"#000"}
              text={"+ Sooo Many More Surprise ones 😉"}
            />
          </View>
        </View>
        <TouchableOpacity
